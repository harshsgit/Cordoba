  ...
  .factory('RzSlider', ['$timeout', '$document', '$window', '$compile', 'RzSliderOptions', 'rzThrottle', function($timeout, $document, $window, $compile, RzSliderOptions, rzThrottle) {
    ...
    Slider.prototype = {
      ...
      updateFloorLab: function () {
          this.translateFn(this.options.isValueToPercentageMode == true ? this.options.floorLabel : this.minValue, this.flrLab, 'floor');
      ...
      updateCeilLab: function() {
          this.translateFn(this.options.isValueToPercentageMode == true ? this.options.ceilLabel : this.maxValue, this.ceilLab, 'ceil');
